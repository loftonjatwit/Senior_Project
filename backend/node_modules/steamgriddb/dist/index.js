...
export default class SGDB {
     ...
     */
    async handleRequest(method, url, params = {}, formData = null) {
        let options = {
     ...
     * @returns A promise resolving to the game's information.
     */
    async getGameBySteamAppId(id, params) {
     ...
     */
    async getGridsById(id, styles, dimensions, mimes, types, nsfw, humor) {
     ...
     */
    async getGridsBySteamAppId(id, styles, dimensions, mimes, types, nsfw, humor) {
        return this.getGrids({
            type: "steam",
            id: id,
            styles: styles,
     ...
     */
    async getHeroesById(id, styles, dimensions, mimes, types, nsfw, humor) {
     ...
     */
    async getHeroesBySteamAppId(id, styles, dimensions, mimes, types, nsfw, humor) {
        return this.getHeroes({
            type: "steam",
            id: id,
            styles: styles,
     ...
     * @returns A promise resolving to a list of heroes for the desired game matching the provided filters.
     */
    async getIconsById(id, styles, dimensions, mimes, types, nsfw, humor) {
     ...
     */
    async getIconsBySteamAppId(id, styles, dimensions, mimes, types, nsfw, humor) {
        return this.getIcons({
            type: "steam",
            id: id,
            styles: styles,
     ...
     */
    async getLogosById(id, styles, dimensions, mimes, types, nsfw, humor) {
     ...
     */
    async getLogosBySteamAppId(id, styles, dimensions, mimes, types, nsfw, humor) {
        return this.getLogos({
            type: "steam",
            id: id,
            styles: styles,
